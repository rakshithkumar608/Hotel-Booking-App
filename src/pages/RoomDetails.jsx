...
useEffect(()=>{
 ...
 room && setMainImage(room.images[0])
            ...
            <h1 className='text-3xl md:text-4xl font-playfair'>Experience Luxury Like
               ...
               <div className='flex flex-wrap item-center mt-3 mb-6 gap-4'>
                {room.amenities.map((item, index) =>(
                  <div key={index} className='flex item-center gap-2 px-3
          ...
          p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
            ...
            md:items-center gap-4 md:gap-10 text-gray-500'>
              ...
              <div className='flex flex-col'>
                ...
                placeholder='Check-In' className='w-full rounded border
                border-gray-300 px-3 py-2 mt-1.5
              ...
              <div className='flex flex-col'>
                ...
                placeholder='Check-Out' className='w-full rounded border
                border-gray-300 px-3 py-2 mt-1.5
                outline-none' required />
              </div>
               ...
               <div className='flex flex-col'>
                ...
                placeholder='0' className='max-w-20 rounded border border-gray-300 
  ...
  <button 
      type="submit" 
      className="bg-blue-600 hover:bg-blue-dull-700 
      active:scale-95 transition-all text-white 
      rounded-md max-md:w-full max-md:mt-6 md:px-25 
      py-3 md:py-4 text-base cursor-pointer"
    >
      Check Availability
    </button>
          </form>
...
my-15 py-10 text-gray-500'>
  <p>Guests will be allocated on the ground floor according to availability.
    You get a comfortable Two bedroom apaetment has a true city feeling. The
    price quoted is for two guests, at the guests slot please mark the number of
    guests to get the extra price for groups. The Guests will be allocated 
    ground floor according to availability. You get a comfortable Two bedroom apaetment has a true city feeling.
  </p>
</div>
...
<button className="bg-blue-600 hover:bg-blue-dull-700 
      active:scale-95 transition-all text-white 
      rounded py-2.5 px-6 mt-4 cursor-pointer">Contact Now</button>
    </div>
  )
}

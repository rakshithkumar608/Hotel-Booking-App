  ...
  return (
    <div>
      <Title
        ...
        font="outfit"
        title="Dashboard"
        subTitle="Moniter your
      room listings, track bookings and analyze revenue-all 
      ...
      <div className="flex gap-4 my-8">
        {/* ------Total Bookings----- */}
        <div
          className="bg-primary/3 border border-primary/10
          rounded fles p-4 pr-8">
          <img
    ...
    rounde-lg max-h-80 overflow-y-scroll'>
              ...
              {dashboardData.bookings.map((item, index) =>(
                <tr key={index}>
                   ...
                   <td className='py-3 px-4 border-t border-gray-300
                     flex'>
                       <button className={`py-1 px-3 rounded-full mx-auto 

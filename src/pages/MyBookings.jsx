...
<Title title="My Bookings" subTitle='Easily manage your past,
        current, and upcoming hotel reservation in one place.
...
<div className='max-w-6xl mt-8 w-full text-gray-800'>
  ...
  {bookings.map((booking) => (
    <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
      ...
      {/* -----Date & Timings---- */}
      <div className='flex flex-row items-start justify-start gap-6 mt-4 md:mt-6'>
      ...
      {/* -----Payment Status---- */}
      <div className=' flex flex-col items-start justify-start mt-4 md:mt-6 h-full'>
        ...
        {!booking.isPaid && (
          <button className='px-4 py-1.5 mt-4 text-xs border border-gray-800 rounded-full hover:bg-gray-50 transition-all cursor-pointer'>
            Pay Now
          </button>
        )}
      </div>
